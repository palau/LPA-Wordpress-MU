...
if ($error_logging) {
    if (!file_exists(WP_PLUGIN_DIR . "/" . ezpz_ocb_slug() . "/error.txt")) {
        $tmp_handle = fopen(WP_PLUGIN_DIR . "/" . ezpz_ocb_slug() . "/error.txt", 'w') or die("can't open file");
        fclose($tmp_handle);
    }
...
//$backup_everything = get_option('ezpz_ocb_backup_everything');
...
//if ($backup_everything === "no") {
//    $bu_what = "your wp-content folder";
//} else {
//    $bu_what = "all your files";
//}
...
//}
//echo "<li><b>Finally we'll zip $bu_what, the restoration script $db_info into:<br/><em>$gold_span $zip_name</span></em></b>";
//
//usleep(250000 * $speed);
$excluded_folders = "";
...
//if ($backup_everything === "no") {
//    $archive_this = "../../$wp_dir/wp-content/";
//} else {
//    $archive_this = "../../$wp_dir/";
//}
//if ($backup_everything === "no") {
...
//echo "<p>EXCLUDED = $exclude_bu_dir</p>";
...
if ($res === TRUE) {
    $zip->addFile("$archive_dir/$tar_name", $tar_name);
    $zip->addFile("$archive_dir/EZPZ_DB.SQL", "EZPZ_DB.SQL");
    $zip->addFile("$archive_dir/EZPZ_RESTORE.PHP", "EZPZ_RESTORE.PHP");
    $zip->close();
//    echo 'ok';
} // else {
...
//    unlink($archive_dir/$tar_name);
//}
//if (file_exists("$archive_dir/EZPZ_DB.SQL")) {
//    unlink("$archive_dir/EZPZ_DB.SQL");
//}
//if (file_exists("$archive_dir/EZPZ_RESTORE.PHP", "EZPZ_RESTORE.PHP")) {
//    unlink("$archive_dir/EZPZ_RESTORE.PHP", "EZPZ_RESTORE.PHP");
//}
