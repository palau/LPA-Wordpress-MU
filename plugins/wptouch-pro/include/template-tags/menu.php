...
function wptouch_has_menu() {
	...
	if ( !$settings->disable_menu ) {	
		$wptouch_menu_dir = $wptouch_pro->get_current_theme_directory() . '/' . $wptouch_pro->get_active_device_class() . '/menu.php';
		return ( file_exists( $wptouch_menu_dir ) );
	} else {
		return false;	
	}
}	
 ...
 *		\arg \c WPTOUCH_ICON_BOOKMARK - The main bookmark icon for the home screen
