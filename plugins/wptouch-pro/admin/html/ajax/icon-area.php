		...
		<div id="manage-set-desc">
			...
			<?php if ( isset( $pack->author ) ) { ?> 
				...
				<div id="manage-set-desc-links">
					<?php if ( isset( $pack->author_url ) ) { ?><a href="<?php echo $pack->author_url; ?>"><?php _e( 'Author Website', 'wptouch-pro' ); ?></a> | <?php } ?><a href="#" class="delete-set"><?php _e( 'Delete Set', 'wptouch-pro' ); ?></a>
				</div>
			<?php } else { ?>
				</h5>
