<div id="manage-sets">	
	...
	<div id="manage-info-area">
		...
		<h5><?php _e( "Home Screen Icons", "wptouch-pro" ); ?>:</h5>
		<p><?php _e( "For images that will used as a Home Screen (Bookmark) icon, they should be 59x60 pixels or higher for best results on iPhone 2G, 3G and 3GS, and 119x120 pixels or higher for iPhone 4.", "wptouch-pro" ); ?></p>
