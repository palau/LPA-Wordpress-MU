...
<?php if ( comments_open() ) : ?>
	...
	<form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
		...
		<p><?php _e( "Logged in as", "wptouch-pro" ); ?> <a href="<?php echo get_option('siteurl'); ?>/wp-admin/profile.php" class="no-ajax"><?php echo $user_identity; ?></a>. <a href="<?php echo wp_logout_url(get_permalink()); ?>" title="<?php _e( "Log out of this account", "wptouch-pro" ); ?>"><?php _e( "Log out", "wptouch-pro" ); ?> &raquo;</a></p>
