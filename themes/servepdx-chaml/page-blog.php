<?php 
/*
Template Name: Get Involved Catgory Page
*/
?>
<?php the_post(); ?>
...
<div id="content" class="clearfix<?php if($fullwidth) echo(' fullwidth');?>">
	<div id="left-area">
		<div class="entry post clearfix">							
			...
			<div class="page-content"> <!-- for page content, this wraps it for css targeting (higher contrast, size) -->
			<?php the_content(); ?>
			</div>
<!-- 			<h2 class="category-title" style="text-align: center; margin: 0.8em 0;">Related Blog Posts</h2> -->
			...
			<div id="et_pt_blog">
				...
				<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
					...
					<div class="et_pt_blogentry clearfix">
						...
						<p class="et_pt_blogmeta">Posted <?php //_e('Posted','Chameleon'); ?> <?php //_e('by','Chameleon'); ?> <?php //the_author_posts_link(); ?> <?php _e('on','Chameleon'); ?> <?php the_time(get_option('chameleon_date_format')) ?> <?php _e('in','Chameleon'); ?> <?php the_category(', ') ?> | <?php comments_popup_link(__('0 comments','Chameleon'), __('1 comment','Chameleon'), '% '.__('comments','Chameleon')); ?></p>
