							...
							<div class="et_pt_portfolio_item">
								...
								<div class="et_pt_portfolio_entry<?php if ( $height == $et_portrait_height ) echo ' et_portrait_layout'; ?>">
									<div class="et_pt_portfolio_image<?php if ($et_videolink <> '') echo ' et_video'; ?>">
										...
										<a class="et_portfolio_zoom_icon" title="<?php the_title(); ?>" rel="prettyPhoto[portfolio]" href="<?php if ($et_videolink <> '') echo $et_videolink; else echo($thumbnail['fullpath']); ?>"><?php _e('Zoom in','Chameleon'); ?></a>
										<a class="et_portfolio_more_icon" href="<?php the_permalink(); ?>"><?php _e('Read more','Chameleon'); ?></a>
