<?php get_header(); ?>
    ...
    <div id="content" class="col-full">
        ...
        <?php while (have_posts()) : the_post(); $count++; ?>
            ...
            <div class="box">
                    <div class="post">
						<?php  /* alternate: show image if imbed, deprecated for now                      
						if (woo_get_embed())
							woo_get_image('image','590');
						else
							echo woo_get_image('image',$GLOBALS['thumb_width'],$GLOBALS['thumb_height'],'thumbnail '.$GLOBALS['align']);
							*/ 
						...
						// set button label, based on whether it's a video (embed)
                        ...
                        <h2 class="title" style="margin-top: 20px"><a href="<?php the_permalink() ?>" rel="bookmark" title="<?php the_title(); ?>"><?php the_title(); ?></a></h2>
                        <p class="post-meta">
							<img src="<?php bloginfo('template_directory'); ?>/images/ico-time.png" alt="" /><?php the_time($GLOBALS['woodate']); ?> Written By: <?php the_author_posts_link(); ?>
