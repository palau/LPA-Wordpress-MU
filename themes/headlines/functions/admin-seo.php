...
function woothemes_seo_page(){
	...
	$seo_options[] = array( "name" => "Custom Post/Page Descriptions",
					"desc" => "Add a custom meta description to your posts and pages. This will only show if no other data is available from the selection above. Even if the option above is set to <strong>'Off'</strong>, will this description still be added to your site.",
	...
	$seo_options[] = array( "name" => "Custom Post/Page Description",
					"desc" => "Add a custom meta description to your posts and pages.",
