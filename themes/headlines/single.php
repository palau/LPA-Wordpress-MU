...
<!-- show video if present, otherwise feature image -->

						<?php if (woo_get_embed())
							echo woo_get_embed('embed','590'/* ,'420' */);
						else
							echo woo_get_image('img_poster','590');
						?>
						
						<?php /*	
if ( woo_get_embed('embed','590','420') && get_option('woo_ad_content') == "true" ) include ( TEMPLATEPATH . '/ads/content_ad.php' );
							else
*/
						?>
                        ...
                        <div class="entry">
							<?php the_content(); ?><?php //echo woo_get_image('img_thumb', '150'); ?>
                        </div>
                        <div class="fix"></div>
