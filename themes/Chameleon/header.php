			...
			if ($primaryNav == '') { ?>
				<ul id="<?php echo $menuID; ?>" class="<?php echo $menuClass; ?>">
					<?php if (get_option('chameleon_home_link') == 'on') { ?>
						<li <?php if (is_home()) echo('class="current_page_item"') ?>><a href="<?php bloginfo('url'); ?>"><?php _e('Home','Chameleon') ?></a></li>
					<?php }; ?>
			...
			<div id="additional-info">
				...
				<div id="search-form">
					<form method="get" id="searchform" action="<?php bloginfo('url'); ?>/">
						<input type="text" value="<?php _e('Search this site...', 'Chameleon'); ?>" name="s" id="searchinput" />
