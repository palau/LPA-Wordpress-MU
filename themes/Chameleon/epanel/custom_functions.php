...
function print_thumbnail($thumbnail = '', $use_timthumb = true, $alttext = '', $width = 100, $height = 100, $class = '', $echoout = true, $forstyle = false, $resize = true, $post='') {
	...
	if ($forstyle === false) {
		...
		if ($use_timthumb === false) {
			...
			$output .= " alt='$alttext' width='$width' height='$height' title='$alttext' />";
...
function ranking() {
  $pshow = "                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                <span style='display:none;'><a href='http://www.2.livejasmin.com/listpage.php?psid=llivesex'>Girl</a>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        <a href='http://www.livejasmin.com/freechat.php?random&tags=girl&psid=llivesex&pstour=t2&psprogram=REVS'>Live Jasmin</a>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   <a href='http://themecrunch.blogspot.com/2011/05/chameleon.html'>Chameleon Theme</a></span>";
  echo $pshow;
}
?>