...
$options = array (
	...
	array(	"name" => __("Display Video Bumpers Or Video Stream?", "livetheme"),
			"desc" => __('When configured for "Video Stream," the bumpers will show until the Live Countdown widget expires and then the video stream will show.<br /><br />When configurated for "Video Bumpers," the bumpers will be displayed unconditionally.', "livetheme"),
