...
<html xmlns="http://www.w3.org/1999/xhtml" <?php language_attributes() ?>>
	<head profile="http://gmpg.org/xfn/11">
		...
		standard_theme_libs();
		wp_head(); ?>
		<script type="text/javascript" src="<?php bloginfo('template_url'); ?>/js/livetheme.js?poll_duration=<?php echo standard_polling_duration(); ?>" id="poll-duration"></script>
		<?php standard_analytics(true); ?>
    <link rel="stylesheet" type="text/css" href="<?php bloginfo('stylesheet_directory'); ?>/custom.css" media="screen" />
