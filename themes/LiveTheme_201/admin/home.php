	...
	<div id="standard_framework">
		...
		<div id="standard_header" class="polish">
			...
			<ul id="standard_topnav">
				<li class="support"><a href="http://support.8bit.io" target="_blank">Support & Community</a></li>
        		<!-- TODO need a documentation icon -->
       			<li class="documentation"><a href="http://livetheme.tv/docs" target="_blank">Documentation</a></li>
				<li class="download-extras"><a href="http://livetheme.tv/extras">Download Extras</a></li>
            </ul><!-- /#standard_topnav -->
					...
					<div id="standard_nav" class="box">
						...
						<ul>
							...
							global $standard_tabs;
							    ...
							    endforeach;?>
                  <!--
							<li class="import-and-export"><a href="#import-and-export">Import And Export</a></li>-->
						</ul>
