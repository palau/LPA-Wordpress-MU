...
$options = array (
	...
	array(	"name" => __("'Tweet This!' Text", "livetheme"),
			"desc" => __("This is the text that will be automatically be entered in the tweet (along with a URL) when users click the \"Tweet This!\" button. The button will not show unless some text is entered.", "livetheme"),
			"id" => "tweet_this_text",
			"type" => "textarea"
	),
	...
	array("name" => __("Social Network #1 Icon", "livetheme"),
		...
		"url" => get_bloginfo('template_directory')."/images/icn-facebook-32.png"
	),
	...
	array("name" => __("Social Network #2 Icon", "livetheme"),
		...
		"type" => "image",
		"value" => "Upload Social Icon",
		"url" => get_bloginfo('template_directory')."/images/icn-twitter-32.png"
	),
	...
	array("name" => __("Social Network #3 Icon", "livetheme"),
		...
		"type" => "image",
		"value" => "Upload Social Icon",
		"url" => get_bloginfo('template_directory')."/images/icn-flickr-32.png"
	),
	...
	array("name" => __("Social Network #4 Icon", "livetheme"),
		...
		"type" => "image",
		"value" => "Upload Social Icon",
		"url" => get_bloginfo('template_directory')."/images/icn-googleplus-32.png",
	),
	...
	array("name" => __("Social Network #5 Icon", "livetheme"),
		...
		"type" => "image",
		"value" => "Upload Social Icon",
		"url" => get_bloginfo('template_directory')."/images/icn-sharethis-32.png"
	),
	...
	array("name" => __("Social Network #6 Icon", "livetheme"),
		...
		"type" => "image",
		"value" => "Upload Social Icon",
		"url" => get_bloginfo('template_directory')."/images/icn-rss-32.png"
	),
