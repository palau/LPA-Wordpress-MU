...
$options = array (
	...
	array(	"name" => __("Sidebar Advertisement Image", "livetheme"),
			...
			"url" => get_bloginfo('stylesheet_directory')."/images/ad-sidebar.jpg"
	),
	...
	array(	"name" => __("Footer Advertisement #1 Image", "livetheme"),
			...
			"url" => get_bloginfo('stylesheet_directory')."/images/ad-footer-1.jpg"
	),
	...
	array(	"name" => __("Footer Advertisement #2 Image", "livetheme"),
			...
			"url" => get_bloginfo('stylesheet_directory')."/images/ad-footer-2.jpg"
	),
	...
	array(	"name" => __("Footer Advertisement #3 Image", "livetheme"),
			...
			"url" => get_bloginfo('stylesheet_directory')."/images/ad-footer-3.jpg"
	),
