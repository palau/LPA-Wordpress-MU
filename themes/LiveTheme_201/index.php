	...
	<div id="content" class="col-full">
		<div id="main-top" class="full-width borders shadow">
			...
			<div id="social-tabs" class="col-right">			
				<ul id="liveTabs">
					...
					<?php endif; ?>
		          <?php if(is_active_sidebar('custom-tab')): ?>
						<li class="custom">
							<a href="javascript:;" class="social-tab">
								<?php echo standard_custom_tab_text(); ?>
							</a>
						</li>
					<?php endif; ?>
				</ul>
          ...
          <div id="tab-custom" class="list">
            <?php dynamic_sidebar('custom-tab'); ?>
          </div>
				</div><!-- /.inside -->
			</div><!-- /Social Tabs -->
			<div class="clear"></div>
		...
		<div id="main-mid" class="full-width borders shadow">
			...
			<div id="mid-right" class="col-right">
				...
				<div id="tweet-out">
          <a href="http://twitter.com/share?text=<?php standard_tweet_this(); ?>" class="tweet-out-btn borders" data-count="vertical" data-via="moretom" target="_blank">
