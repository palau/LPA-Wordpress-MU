 ...
 * Load our widget.
 */
add_action( 'widgets_init', 'ti_ad_220x125_widgets' );

/*
 * Register widget.
 */
function ti_ad_220x125_widgets() {
	register_widget( 'ti_ad_220x125_widget' );
}

/*
 * Widget class.
 */
class ti_ad_220x125_widget extends WP_Widget {

	function ti_ad_220x125_widget() 
	{
		/* Widget settings */
		$widget_ops = array( 'classname' => 'ti-ad-widget', 'description' => __( 'Display a single 220x125 ad block.', 'theme-it') );

		/* Widget control settings */
		$control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => 'ti_ad_220x125_widget' );

		/* Create the widget */
		$this->WP_Widget( 'ti_ad_220x125_widget', __( 'Single Ad - Sidebar', 'theme-it' ), $widget_ops, $control_ops );
	}
