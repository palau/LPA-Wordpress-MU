 ...
 * Load our widget.
 */
add_action( 'widgets_init', 'ti_ads_125x125_widgets' );

/*
 * Register widget.
 */
function ti_ads_125x125_widgets() {
	register_widget( 'ti_ads_125x125_widget' );
}

/*
 * Widget class.
 */
class ti_ads_125x125_widget extends WP_Widget {

	function ti_ads_125x125_widget() 
	{
		/* Widget settings */
		$widget_ops = array( 'classname' => 'ti-ad-widget', 'description' => __( 'Display up to six 125x125 ad blocks.', 'theme-it' ) );

		/* Widget control settings */
		$control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => 'ti_ads_125x125_widget' );

		/* Create the widget */
		$this->WP_Widget( 'ti_ads_125x125_widget', __( 'Multi Ads - Footer', 'theme-it' ), $widget_ops, $control_ops );
	}
	...
	function widget( $args, $instance ) 
	{
		...
		<div class="ads-125x125 clearfix">
			<ul class="clearfix">
	...
	function form( $instance ) {
		...
		$defaults = array( 
			'title'  => __( 'Our Sponsors', 'theme-it' ),
